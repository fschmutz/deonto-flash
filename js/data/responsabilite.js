...
export const RESPONSABILITE = [
  {
    ...
    qcm: [
      ...
      { q: 'Les assurances obligatoires de l’avocat comprennent notamment :', o: ['une seule police « tous risques »', 'la RCP et l’assurance des fonds (maniements), à ne pas confondre', 'uniquement une assurance automobile du cabinet'], b: 1, e: 'Deux assurances obligatoires distinctes : RCP et fonds / maniements.' },
      { q: 'Le défaut d’assurance RCP :', o: ['est sans conséquence ordinale', 'empêche l’exercice et expose à l’omission / discipline', 'n’intéresse que l’assureur'], b: 1, e: 'Condition d’exercice contrôlée par l’Ordre.' },
      { q: 'La garantie RCP couvre :', o: ['la fraude intentionnelle de l’avocat', 'les conséquences pécuniaires de la responsabilité civile professionnelle selon les termes de la police et des minimums légaux', 'les amendes pénales personnelles'], b: 1, e: 'Couverture de la RCP ; exclusions classiques pour dol / amendes pénales.' },
      { q: 'En cas de réclamation, le premier réflexe assurantiel est :', o: ['nier systématiquement sans déclarer', 'déclarer le sinistre à l’assureur dans les délais de la police', 'attendre la radiation'], b: 1, e: 'Déclaration de sinistre ; ne pas aggraver le risque par le silence.' }
    ],
    jury: [
      ...
      { q: 'Pourquoi distinguer RCP et assurance des fonds ?', r: 'La RCP couvre les fautes professionnelles causant un préjudice au client ou au tiers. L’assurance des maniements de fonds couvre la restitution des fonds confiés. Les plafonds, franchises et exclusions diffèrent. Les confondre à l’oral montre une lacune. Les deux sont obligatoires et contrôlées pour l’inscription.' },
      { q: 'Que faire à la première réclamation écrite d’un client ?', r: 'Déclarer à l’assureur, informer le bâtonnier si la voie déontologique est engagée, préserver les preuves, éviter les aveux précipités non coordonnés avec l’assureur, et ne pas tenter de « négocier en silence » une faute couverte. La prévention (conflict check, délais, documentation) reste le meilleur discours complémentaire.' }
    ],
    cas: {
    ...
    cas2: {
      e: 'Vous découvrez qu’une police RCP n’a pas été renouvelée depuis deux mois alors que le cabinet continue d’exercer. Conduite ?',
      r: 'Cesser immédiatement tout risque nouveau si la garantie est effectivement interrompue, régulariser la police le jour même, informer le bâtonnier (condition d’exercice), et déclarer tout sinistre potentiel survenu pendant la période de trou de garantie. Vérifier la police fonds. Documenter. La poursuite d’exercice sans assurance est un manquement grave.'
    }
  },

  {
    ...
    qcm: [
      ...
      { q: 'La réclamation déontologique et l’action civile :', o: ['s’excluent', 'sont indépendantes', 'fusent toujours en une seule instance'], b: 1, e: 'Voies indépendantes : déontologique, civile, parfois pénale.' },
      { q: 'Le fondement civil classique de la responsabilité de l’avocat est :', o: ['l’article 1240 / 1231‑1 du code civil selon contractuel ou délictuel', 'le seul RIN', 'l’article 66‑5 de la loi de 1971'], b: 1, e: 'Responsabilité civile contractuelle ou délictuelle selon les cas (C. civ.).' },
      { q: 'Depuis le décret du 30 juin 2022, le traitement des réclamations :', o: ['a disparu', 'a été précisé dans le sens d’une meilleure orientation du justiciable', 'est confié au seul CNB'], b: 1, e: 'Modernisation du traitement / orientation des réclamations.' },
      { q: 'Une réclamation déontologique peut aboutir à :', o: ['des dommages‑intérêts automatiquement', 'une médiation, un classement, ou des poursuites disciplinaires', 'la révision du procès perdu'], b: 1, e: 'Finalité ordinale, pas une voie de réformation judiciaire du fond.' }
    ],
    jury: [
      ...
      { q: 'Comment orientez‑vous un justiciable mécontent ?', r: 'En distinguant clairement : contestation d’honoraires (bâtonnier), réclamation déontologique (Ordre), action en responsabilité civile (TJ), voie pénale si infraction. Le décret de 2022 a clarifié l’orientation. Ne pas promettre que la discipline « fera gagner » le procès perdu. Documenter la réception de la plainte et les délais.' },
      { q: 'L’avocat mis en cause doit‑il s’expliquer au bâtonnier ?', r: 'Oui, loyalement, tout en préservant le secret à l’égard des tiers. Les échanges avec l’autorité ordinale obéissent à un régime particulier. Déclaration à l’assureur. Attitude constructive sans reconnaissance précipitée non maîtrisée.' }
    ],
    cas: {
...

  {
    ...
    cartes: [
      ...
      { q: 'Qu’est‑ce que le visa du bâtonnier ?', r: 'Une obligation d’information et de communication préalable dans les hypothèses prévues, non une autorisation de méconnaître la loi.', src: 'RIN ; D. 1991' },
      { q: 'Citez trois mesures préventives classiques.', r: 'Conflict check documenté, convention d’honoraires / lettre de mission, déclaration immédiate à l’assureur et suivi des délais de procédure.', src: 'RIN ; L. 1971 ; D. 1991' },
      { q: 'Pourquoi la prévention est‑elle un sujet autonome du programme ?', r: 'Parce qu’elle articule déontologie, RCP et organisation du cabinet : mieux vaut prévenir la faute que plaider la garantie.', src: 'Programme exam. ; RIN' }
    ],
    qcm: [
      ...
      { q: 'Le visa du bâtonnier est :', o: ['une autorisation de plaider au fond', 'une obligation d’information / communication préalable dans les cas prévus, jamais une autorisation de violer la loi', 'un acte fiscal'], b: 1, e: 'Visa = information préalable, pas un blanc‑seing.' },
      { q: 'Les mesures préventives visent surtout à :', o: ['augmenter le chiffre d’affaires', 'réduire les risques déontologiques, disciplinaires et de responsabilité', 'remplacer la formation continue'], b: 1, e: 'Prévention : conflict check, lettres de mission, délais, assurances, LCB‑FT, etc.' },
      { q: 'Un conflict check écrit :', o: ['est inutile en cabinet individuel', 'est une mesure préventive essentielle, y compris en exercice individuel', 'est réservé aux barreaux de plus de 200 avocats'], b: 1, e: 'Utile partout : traçabilité des conflits et des refus.' },
      { q: 'La lettre de mission / convention d’honoraires :', o: ['n’a qu’un intérêt comptable', 'prévient les litiges sur l’étendue de la mission et la rémunération', 'est interdite en urgence absolue sans exception'], b: 1, e: 'Prévention du contentieux d’honoraires et clarification du mandat.' }
    ],
    jury: [
      ...
      { q: 'Comment construire un plan sur les mesures préventives ?', r: 'I. Prévenir le conflit et le secret (conflict check, ethical wall, lettres de mission). II. Prévenir le risque patrimonial et ordinal (assurances, CARPA, formation, LCB‑FT, visa). Insister sur la documentation : ce qui n’est pas écrit n’existe pas en cas de réclamation. Relier à la RCP et aux réclamations pour montrer la cohérence du bloc 6.' },
      { q: 'Le visa dispense‑t‑il de réfléchir ?', r: 'Non. C’est une information du bâtonnier, pas une validation du fond ni une autorisation de violer le secret ou la loi. L’avocat demeure responsable de ses choix. Le visa mal compris est un piège d’oral.' }
    ],
    cas: {
