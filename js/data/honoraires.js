...
export const HONORAIRES = [
  {
    ...
    qcm: [
      ...
      { q: 'Le pacte de quota litis est :', o: ['autorisé depuis 2015', 'interdit', 'obligatoire en AJ'], b: 1, e: 'Interdiction du pacte de quota litis (honoraire uniquement proportionnel au résultat).' },
      { q: 'L’honoraire de résultat complémentaire :', o: ['est le pacte de quota litis', 'est possible s’il s’ajoute à un honoraire de diligence', 'est toujours nul'], b: 1, e: 'Résultat complémentaire autorisé ; quota litis pur interdit.' },
      { q: 'Le bâtonnier, en matière d’honoraires, est :', o: ['simple médiateur sans décision', 'juge de première instance de la contestation d’honoraires', 'dessaisi au profit du CNB'], b: 1, e: 'Juge de l’honoraire en première instance (D. 1991 art. 174 s.).' },
      { q: 'L’honoraire librement payé après service rendu :', o: ['est toujours réductible', 'n’est pas réductible sous trois conditions classiques (liberté, connaissance, absence de pression)', 'est interdit'], b: 1, e: 'Principe de non‑réduction de l’honoraire librement payé après service rendu, sous conditions.' }
    ],
    jury: [
      ...
      { q: 'Pourquoi le pacte de quota litis est‑il interdit ?', r: 'Parce qu’il lie la rémunération au seul résultat et fait de l’avocat un co‑intéressé, au détriment de l’indépendance et de la dignité. L’honoraire de résultat complémentaire, additionné à un honoraire de diligence, reste possible. La convention écrite depuis 2015 sécurise l’accord, hors urgences, force majeure ou AJ totale. Le bâtonnier tranche les contestations en premier ressort.' },
      { q: 'Comment articuler AJ et convention d’honoraires ?', r: 'En AJ totale, la convention n’est pas obligatoire, mais une convention pour le cas de retour à meilleure fortune est prudente. Aucun honoraire complémentaire occulté. L’information du client sur le barème et les conditions de l’AJ est un devoir. La confusion AJ / honoraire libre est une faute fréquente.' }
    ],
    cas: {
    ...
    cas2: {
      e: 'Vous proposez 300 € de diligences et 40 % des sommes obtenues en dommages‑intérêts, sans autre fixe. Le client signe. Validité ?',
      r: 'Risque majeur de qualification en pacte de quota litis si le fixe est dérisoire au regard du résultat. L’honoraire de résultat doit être complémentaire d’un honoraire de diligence réel. 40 % peut en outre être excessif selon la matière. Il faut réécrire la convention : diligences sérieuses + résultat plafonné et proportionné. En cas de contestation, le bâtonnier pourra réduire. Mieux vaut corriger avant exécution.'
    }
  },

  {
    ...
    qcm: [
      ...
      { q: 'Le compte détaillé par affaire est :', o: ['une simple faculté', 'une obligation déontologique et comptable', 'réservé aux SEL'], b: 1, e: 'Obligation de tenir un compte détaillé par affaire.' },
      { q: 'Les fonds clients :', o: ['peuvent transiter sur le compte personnel de l’avocat', 'doivent respecter le régime CARPA / maniements de fonds', 'sont libres d’emploi pendant 30 jours'], b: 1, e: 'Maniement via CARPA ; pas de confusion avec les fonds personnels.' },
      { q: 'Le contrôle de la comptabilité relève notamment :', o: ['du seul expert‑comptable du client', 'du conseil de l’ordre', 'de la Conférence des bâtonniers exclusivement'], b: 1, e: 'Contrôle ordinal de la comptabilité des avocats.' },
      { q: 'L’absence de comptabilité régulière :', o: ['est sans incidence disciplinaire', 'constitue un manquement pouvant fonder discipline et difficultés d’assurance', 'n’intéresse que l’URSSAF'], b: 1, e: 'Manquement déontologique grave, au‑delà des seules conséquences fiscales.' }
    ],
    jury: [
      ...
      { q: 'Pourquoi la comptabilité est‑elle un sujet de déontologie ?', r: 'Parce que la transparence des honoraires, la protection des fonds clients et le contrôle ordinal exigent une comptabilité régulière, avec compte par affaire. Ce n’est pas qu’une technique fiscale. Le défaut expose à la discipline, à des difficultés d’assurance et à des soupçons LCB‑FT. Relier comptabilité, CARPA et honoraires dans le plan.' },
      { q: 'Que répondre sur le compte par affaire ?', r: 'Il permet de justifier diligences, provisions et soldes, de restituer les fonds, et de répondre au bâtonnier en cas de réclamation. C’est une pièce centrale du dossier professionnel, autant que la convention d’honoraires.' }
    ],
    cas: {
...

  {
    ...
    qcm: [
      ...
      { q: 'Les rémunérations techniques des associés de SEL sont imposées en BNC depuis :', o: ['2010', '2022 (réforme)', '1991'], b: 1, e: 'Imposition en BNC depuis 2022 pour ces rémunérations techniques, selon le corpus.' },
      { q: 'Le droit de communication de l’administration fiscale :', o: ['permet d’exiger la nature des prestations couvertes par le secret', 'est borné : identité, montants, dates, forme des versements ; pas la nature des prestations', 'est total sur tout le dossier'], b: 1, e: 'Jurisprudence CE : bornes du droit de communication vs secret.' },
      { q: 'La TVA sur les honoraires d’avocat :', o: ['n’existe jamais', 's’applique selon les règles fiscales de droit commun à l’activité', 'est fixée par le bâtonnier'], b: 1, e: 'Régime de TVA de droit commun applicable à l’activité, hors cas particuliers légaux.' },
      { q: 'Fiscalité et secret professionnel :', o: ['le secret cède toujours au fisc', 'coexistent dans un équilibre défini par la loi et la jurisprudence', 'le secret interdit toute déclaration fiscale'], b: 1, e: 'Déclarations fiscales oui ; communication limitée sur le contenu des prestations.' }
    ],
    jury: [
      ...
      { q: 'Comment traiter la fiscalité sans transformer l’oral en cours de CGI ?', r: 'Rester sur l’articulation avec la déontologie : secret vs droit de communication, obligations déclaratives, régime des SEL et BNC depuis 2022, TVA. Citer le Conseil d’État sur les limites de la communication. Ne pas inventer de taux ni de seuils. Montrer que l’avocat n’utilise pas le secret pour frauder, mais refuse de livrer la nature des prestations.' },
      { q: 'Un contrôle fiscal au cabinet : réflexe ?', r: 'Vérifier le périmètre du droit de communication, associer le bâtonnier si perquisition ou atteinte au secret, ne communiquer que ce qui est communicable, documenter. Séparer comptabilité et dossiers de fond. Alerter l’assureur si besoin.' }
    ],
    cas: {
...

  {
    ...
    qcm: [
      ...
      { q: 'Le dépôt des fonds à la CARPA doit intervenir :', o: ['dans les six mois', 'sans délai', 'à la clôture du dossier'], b: 1, e: 'Dépôt sans délai ; le défaut peut caractériser un abus de confiance.' },
      { q: 'La CARPA :', o: ['est un compte personnel de l’avocat', 'reçoit les maniements de fonds et assure un contrôle collectif', 'remplace l’assurance RCP'], b: 1, e: 'Institution de maniement et de contrôle des fonds de tiers.' },
      { q: 'L’avocat peut‑il conserver des fonds clients sur son compte professionnel librement ?', o: ['oui, jusqu’à 10 000 euros', 'non, hors exceptions légales strictes ; le circuit CARPA s’impose', 'oui, avec accord oral du client'], b: 1, e: 'Circuit CARPA obligatoire pour les maniements, hors exceptions prévues.' },
      { q: 'Depuis 2020, la CARPA au regard de la LCB‑FT :', o: ['est hors champ', 'est assujettie', 'n’est assujettie que pour l’AJ'], b: 1, e: 'Assujettissement LCB‑FT depuis 2020.' }
    ],
    jury: [
      ...
      { q: 'Pourquoi la CARPA est‑elle un pilier de la confiance publique ?', r: 'Parce qu’elle sépare les fonds de tiers des fonds de l’avocat, assure traçabilité et contrôle, et réduit le risque d’abus de confiance. Le dépôt doit être immédiat. La CARPA finance aussi, selon les textes, des actions d’intérêt collectif. Depuis 2020, elle est assujettie à la LCB‑FT. L’oral doit distinguer clairement CARPA, honoraires et comptabilité du cabinet.' },
      { q: 'Que risque le défaut de dépôt ?', r: 'Qualification possible d’abus de confiance, manquement disciplinaire grave, conséquences assurancielles. L’urgence du dossier n’excuse pas la confusion des fonds. Régulariser immédiatement et informer le bâtonnier si le manquement a déjà eu lieu.' }
    ],
    cas: {
    ...
    cas2: {
      e: 'Un client vous remet un chèque de 50 000 € « pour négocier plus vite » et vous demande de le garder en coffre une semaine avant de le déposer. Que faites‑vous ?',
      r: 'Refus de la conservation hors CARPA : dépôt sans délai. Vous expliquez l’obligation légale et déontologique, déposez à la CARPA, et documentez l’instruction du client. Si le client retire son mandat faute de « souplesse », vous assumez : la confusion des fonds n’est pas négociable. Alerte bâtonnier seulement si un manquement s’est déjà produit.'
    }
  }
];
