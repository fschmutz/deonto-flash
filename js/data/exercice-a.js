...
export const EXERCICE_A = [
  {
    ...
    cartes: [
      ...
      { q: 'La pluralité de domiciles est‑elle autorisée ?', r: 'Oui : un cabinet principal et un ou plusieurs bureaux secondaires, dans le respect du RIN et du décret de 1991.', src: 'RIN art. 15' },
      { q: 'Quel texte conventionnel protège le domicile professionnel ?', r: 'L’article 8 de la CEDH, relatif au respect de la vie privée et du domicile, s’ajoute aux garanties professionnelles.', src: 'art. 8 CEDH' },
      { q: 'Qui exerce le contrôle ordinal sur le domicile ?', r: 'Le conseil de l’ordre, dans le cadre de la police du tableau et des conditions d’exercice.', src: 'D. 27 nov. 1991 ; RIN' }
    ],
    qcm: [
      ...
      { q: 'La pluralité de domiciles professionnels est :', o: ['interdite', 'autorisée : cabinet principal et bureaux secondaires', 'réservée aux SEL'], b: 1, e: 'Un cabinet principal et un ou plusieurs bureaux secondaires sont possibles sous conditions.' },
      { q: 'Le domicile professionnel est protégé notamment par :', o: ['le seul règlement intérieur local', 'l’article 8 CEDH, outre les textes professionnels', 'le droit commercial exclusivement'], b: 1, e: 'Vie privée et domicile : art. 8 CEDH ; RIN art. 15 et décret de 1991.' },
      { q: 'L’absence de domicile professionnel réel et sérieux peut entraîner :', o: ['une simple amende ordinale', 'un refus ou un retrait d’inscription', 'aucune conséquence'], b: 1, e: 'Condition d’exercice : un domicile réel et sérieux est exigé pour l’inscription.' },
      { q: 'Le domicile peut‑il être fixé au domicile personnel ?', o: ['jamais', 'sous conditions garantissant le secret et l’indépendance, selon les textes et usages', 'uniquement la première année'], b: 1, e: 'Possible sous conditions strictes de secret, d’accessibilité et d’indépendance.' },
      { q: 'Qui contrôle les conditions du domicile professionnel ?', o: ['le seul CNB', 'le conseil de l’ordre', 'Tracfin'], b: 1, e: 'Police du tableau et contrôle ordinal : conseil de l’ordre / bâtonnier.' }
    ],
    jury: [
      ...
      { q: 'Pourquoi le domicile professionnel n’est‑il pas une simple formalité ?', r: 'Il conditionne l’inscription, la protection du secret, la compétence territoriale ordinale et la possibilité pour le justiciable de joindre son conseil. Un domicile fictif ou incompatible avec le secret expose à l’omission ou au refus d’inscription. La pluralité (principal / secondaires) suppose des garanties matérielles et déontologiques. L’article 8 CEDH rappelle que le cabinet n’est pas un lieu banalisé.' },
      { q: 'Comment présenter l’articulation domicile et bureaux secondaires ?', r: 'Le domicile principal ancre l’inscription au tableau. Les bureaux secondaires étendent l’accueil sous déclaration ou autorisation selon les textes, avec motifs de refus liés aux conditions d’exercice. Ne pas confondre domiciliation commerciale opaque et installation professionnelle contrôlée par l’Ordre.' }
    ],
    cas: {
...

  {
    ...
    cartes: [
      ...
      { q: 'Quels motifs de refus d’un bureau secondaire sont opérants ?', r: 'Ceux tirés des conditions matérielles et déontologiques d’exercice, non un simple argument de concurrence locale.', src: 'RIN art. 15.3' },
      { q: 'Quel apport de la loi du 6 août 2015 ?', r: 'Un assouplissement du régime d’établissement des bureaux secondaires, pour faciliter l’installation.', src: 'L. 6 août 2015' },
      { q: 'Que doit garantir un bureau secondaire ?', r: 'Des conditions matérielles sérieuses, le secret professionnel et l’indépendance de l’avocat.', src: 'RIN art. 15.3 ; D. 1991' }
    ],
    qcm: [
      ...
      { q: 'Les motifs de refus d’un bureau secondaire portent notamment sur :', o: ['la concurrence locale seule', 'les conditions matérielles et déontologiques d’exercice', 'la nationalité du clientèle'], b: 1, e: 'Conditions matérielles et déontologiques ; pas un protectionnisme de pure concurrence.' },
      { q: 'Depuis la loi du 6 août 2015, le régime des bureaux secondaires a été :', o: ['supprimé', 'assoupli pour faciliter l’établissement', 'réservé aux barreaux de plus de 200 avocats'], b: 1, e: 'Assouplissement légal de 2015, dans le cadre du RIN art. 15.3.' },
      { q: 'Un bureau secondaire peut‑il être ouvert hors du ressort du barreau d’inscription ?', o: ['non, jamais', 'oui, sous les conditions prévues par les textes', 'uniquement dans l’Union européenne'], b: 1, e: 'Ouverture possible sous conditions ; information / autorisation selon le dispositif applicable.' },
      { q: 'Le défaut de déclaration ou d’autorisation expose à :', o: ['aucune sanction', 'des suites ordinales et disciplinaires', 'la seule nullité des actes de procédure'], b: 1, e: 'Police du tableau et discipline : l’exercice occulte d’un bureau est fautif.' },
      { q: 'Le bureau secondaire doit garantir :', o: ['uniquement une boîte postale', 'les conditions d’exercice, de secret et d’indépendance', 'la présence quotidienne du bâtonnier'], b: 1, e: 'Conditions matérielles, secret, indépendance : au cœur du contrôle ordinal.' }
    ],
    jury: [
      ...
      { q: 'Le bureau secondaire est‑il un domicile de complaisance ?', r: 'Non. C’est un lieu d’exercice contrôlé, qui doit offrir les mêmes garanties de secret et d’indépendance que le cabinet principal. Le conseil de l’ordre peut s’opposer pour des motifs liés aux conditions d’exercice. La loi de 2015 a assoupli le régime sans le banaliser. À l’oral, relier ce sujet au domicile professionnel et à la publicité (pas d’ambiguïté sur le lieu réel d’exercice).' },
      { q: 'Que répondre sur un refus « protectionniste » du barreau d’accueil ?', r: 'Un refus fondé sur la seule crainte de concurrence est fragile au regard de la liberté d’établissement et du contrôle de légalité. En revanche, l’insuffisance matérielle, l’atteinte au secret ou l’incompatibilité déontologique sont des motifs opérants. La cour d’appel contrôle la légalité, non l’opportunité économique.' }
    ],
    cas: {
...

  {
    ...
    qcm: [
      ...
      { q: 'Représentation et assistance se distinguent en ce que :', o: ['elles sont synonymes', 'la représentation emporte pouvoir d’agir au nom du client ; l’assistance l’accompagne', 'l’assistance est réservée aux magistrats'], b: 1, e: 'Représentation = agir au nom ; assistance = conseil et accompagnement.' },
      { q: 'L’acte d’avocat a été consacré par :', o: ['la loi du 31 décembre 1971 uniquement', 'la loi du 28 mars 2011', 'le seul RIN'], b: 1, e: 'Loi du 28 mars 2011 : acte sous signature privée contresigné par avocat.' },
      { q: 'Le monopole de représentation devant le TJ :', o: ['n’existe plus', 'demeure dans les matières où la représentation est obligatoire, sous réserves légales', 'vaut devant toutes les juridictions sans exception'], b: 1, e: 'Monopole là où la représentation obligatoire est prévue ; exceptions légales à connaître.' },
      { q: 'Le conseil juridique hors représentation :', o: ['est interdit à l’avocat', 'entre dans le champ d’activité, avec les limites des incompatibilités et du secret', 'est réservé aux experts‑comptables'], b: 1, e: 'Le conseil est au cœur du métier ; borné par incompatibilités, conflicts et LCB‑FT.' }
    ],
    jury: [
      ...
      { q: 'Comment structurer le champ d’activité à l’oral ?', r: 'Partir du monopole de représentation et d’assistance là où la loi le réserve, puis du conseil et de la rédaction d’actes, enfin des activités accessoires autorisées (fiducie, médiation, arbitrage, etc.) sous conditions. Distinguer ce qui est exclusif, ce qui est partagé avec d’autres professions, et ce qui est interdit. L’acte d’avocat (2011) illustre la montée en puissance de la preuve et de la loyauté documentaire.' },
      { q: 'L’avocat peut‑il tout faire dès lors que c’est « juridique » ?', r: 'Non. Incompatibilités, conflits d’intérêts, LCB‑FT, publicité et structures bornent le champ. Une activité lucrative étrangère à la profession, ou un partage d’honoraires avec un non‑avocat, font basculer hors du cadre. Le jury attend cette conscience des limites autant que l’énumération des prérogatives.' }
    ],
    cas: {
...

  {
    ...
    cartes: [
      ...
      { q: 'Quand s’apprécie l’incompatibilité ?', r: 'Principalement au moment de l’inscription au tableau ; son régime d’interprétation est strict.', src: 'D. 27 nov. 1991, art. 111 s.' },
      { q: 'Quel est le fondement déontologique des incompatibilités ?', r: 'L’indépendance de l’avocat : écarter les activités qui le placeraient sous une dépendance contraire à sa mission.', src: 'RIN art. 1.1 ; L. 1971' },
      { q: 'Que risque l’avocat qui exerce malgré une incompatibilité ?', r: 'Refus ou retrait d’inscription, omission, et poursuites disciplinaires.', src: 'D. 1991 ; RIN' }
    ],
    qcm: [
      ...
      { q: 'L’incompatibilité s’apprécie :', o: ['seulement au jour d’une audience', 'au moment de l’inscription, avec une interprétation stricte', 'uniquement sur plainte du parquet'], b: 1, e: 'Appréciation à l’inscription ; interprétation stricte des textes.' },
      { q: 'Une incompatibilité non levée expose à :', o: ['une simple recommandation', 'un refus d’inscription ou une omission / discipline', 'aucune suite si le chiffre d’affaires est faible'], b: 1, e: 'Police du tableau et discipline : l’incompatibilité est une condition d’exercice.' },
      { q: 'Le cumul avec certaines fonctions publiques est :', o: ['toujours libre', 'encadré voire interdit selon les textes du décret de 1991', 'imposé par le CNB'], b: 1, e: 'Décret 91‑1197 art. 111 s. : régime précis d’incompatibilités.' },
      { q: 'La loi du 6 août 2015 a notamment :', o: ['supprimé toutes les incompatibilités', 'assoupli certains cumuls dans une logique d’ouverture', 'interdit toute activité accessoire'], b: 1, e: 'Assouplissements ciblés, sans disparition du principe d’indépendance.' }
    ],
    jury: [
      ...
      { q: 'Incompatibilité et conflit d’intérêts : comment les distinguer ?', r: 'L’incompatibilité est statutaire : elle interdit certaines activités ou fonctions a priori, pour préserver l’indépendance. Le conflit d’intérêts est situationnel : il naît entre clients ou avec l’intérêt personnel dans un dossier donné. On peut être compatible statutairement et néanmoins en conflit sur une affaire. L’oral gagne à ne pas fusionner les deux notions.' },
      { q: 'Pourquoi une interprétation stricte des incompatibilités ?', r: 'Parce qu’elles restreignent la liberté d’exercice et d’entreprendre. Le texte doit être clair ; l’analogie extensive est suspecte. En même temps, le principe d’indépendance irrigue la lecture des cas limites. La réforme de 2015 illustre la recherche d’un équilibre entre ouverture et déontologie.' }
    ],
    cas: {
...

  {
    ...
    cartes: [
      ...
      { q: 'Quelle loi a ouvert la sollicitation personnalisée ?', r: 'La loi du 17 mars 2014, sous conditions de loyauté et de respect des règles professionnelles.', src: 'L. 17 mars 2014 ; RIN art. 10' },
      { q: 'Publicité catégorielle et sollicitation personnalisée : même régime ?', r: 'Non. La publicité ciblée par catégories n’est pas une sollicitation adressée à une personne déterminée.', src: 'RIN art. 10' },
      { q: 'Quels principes bornent toute publicité d’avocat ?', r: 'Loyauté, exactitude, dignité, secret : pas de publicité mensongère ni d’atteinte au secret.', src: 'RIN art. 10' }
    ],
    qcm: [
      ...
      { q: 'La sollicitation personnalisée a été ouverte par :', o: ['la loi du 31 décembre 1971', 'la loi du 17 mars 2014', 'le seul usage du barreau de Paris'], b: 1, e: 'Loi du 17 mars 2014 : sollicitation personnalisée encadrée.' },
      { q: 'La publicité ciblée par catégories est :', o: ['identique à la sollicitation personnalisée', 'distincte : elle n’est pas une sollicitation personnalisée', 'toujours interdite'], b: 1, e: 'Publicité par catégories ≠ sollicitation personnalisée adressée à une personne déterminée.' },
      { q: 'Une publicité mensongère ou comparative déloyale est :', o: ['tolérée si efficace', 'prohibée', 'réservée aux spécialités'], b: 1, e: 'RIN art. 10 : loyauté, exactitude ; pas de publicité mensongère.' },
      { q: 'Le démarchage agressif demeure :', o: ['autorisé depuis 2014', 'interdit ; la sollicitation personnalisée n’est pas un démarchage libre', 'obligatoire pour les jeunes barreaux'], b: 1, e: 'Ouverture encadrée, pas une liberté de démarchage à l’américaine.' }
    ],
    jury: [
      ...
      { q: 'Comment exposer l’évolution de la publicité sans caricature ?', r: 'Longtemps restrictive au nom de la dignité, la publicité personnelle s’est ouverte (RIN art. 10), puis la sollicitation personnalisée en 2014. L’ouverture n’est pas un blanc‑seing : exactitude, dignité, absence d’atteinte au secret et aux confrères. Distinguer site, annuaire, publicité catégorielle et message personnalisé. Le jury sanctionne autant l’anachronisme (« toute publicité est interdite ») que le laxisme.' },
      { q: 'Un message LinkedIn à un prospect nommé est‑il libre ?', r: 'C’est typiquement le champ de la sollicitation personnalisée : autorisée sous conditions, pas un spam commercial. Le contenu doit être loyal, informatif, non agressif, et respecter le secret. La traçabilité et la mesure du propos sont des réflexes professionnels.' }
    ],
    cas: {
    ...
    cas2: {
      e: 'Votre associé fait publier une annonce promettant « gain garanti à 100 % devant le conseil de prud’hommes ». Que faites‑vous ?',
      r: 'La publicité est mensongère et contraire à la dignité : aucun résultat judiciaire n’est garanti. Vous faites retirer l’annonce, informez le bâtonnier si le manquement est caractérisé, et rappelez en interne le RIN art. 10. La responsabilité ordinale peut être engagée pour la structure comme pour l’auteur. Une communication corrective peut s’imposer selon le degré de diffusion.'
    }
  },

  {
    ...
    qcm: [
      ...
      { q: 'Le volume de formation continue est de :', o: ['dix heures par an', 'vingt heures par an ou quarante sur deux ans', 'cinquante heures par an'], b: 1, e: 'Vingt heures par an ou quarante sur deux ans : lissage possible.' },
      { q: 'Le contrôle du respect de la formation continue relève notamment :', o: ['du seul CNB', 'du conseil de l’ordre', 'de Tracfin'], b: 1, e: 'Contrôle ordinal ; le défaut peut fonder une omission facultative ou des suites disciplinaires.' },
      { q: 'La formation à la déontologie et à la LCB‑FT :', o: ['est facultative', 'entre dans le parcours obligatoire de formation continue', 'ne concerne que les fiduciaires'], b: 1, e: 'Composantes imposées dans le dispositif de formation continue.' },
      { q: 'Le décret du 1er décembre 2023 :', o: ['supprime la formation continue', 'actualise le régime de la formation continue', 'transfère le contrôle au parquet'], b: 1, e: 'Actualisation réglementaire du dispositif de formation continue.' }
    ],
    jury: [
      ...
      { q: 'Pourquoi la formation continue est‑elle un sujet disciplinaire autant que pédagogique ?', r: 'Parce que l’obligation est légale et réglementaire : vingt heures par an ou quarante sur deux ans, avec des contenus imposés (déontologie, LCB‑FT notamment). Le conseil de l’ordre contrôle ; le manquement peut entraîner omission ou discipline. Ce n’est pas un simple « bonus » de carrière. À l’oral, citer la loi de 2004, le décret de 1991 et les actualisations récentes, dont 2023.' },
      { q: 'Peut‑on lisser les heures sur deux ans ?', r: 'Oui : quarante heures sur deux ans permettent le lissage. Cela n’autorise pas à reporter indéfiniment : le contrôle s’apprécie sur la période. Conserver les attestations. Les formations suivies doivent être éligibles selon les règles du CNB et de l’Ordre.' }
    ],
    cas: {
