...
export const EXERCICE_B = [
  {
    ...
    qcm: [
      ...
      { q: 'Le nombre maximal de mentions de spécialisation par avocat est de :', o: ['une', 'deux', 'quatre'], b: 1, e: 'Deux mentions de spécialisation au maximum par avocat, sur une liste réglementée.' },
      { q: 'La liste des mentions est fixée par :', o: ['chaque bâtonnier librement', 'arrêté (liste) et décisions normatives du CNB', 'le seul contrat de collaboration'], b: 1, e: 'Arrêté du 28 décembre 2011 et évolutions via le CNB ; vingt‑huit mentions.' },
      { q: 'L’obtention d’une mention suppose notamment :', o: ['six mois d’exercice', 'quatre ans de pratique dominante et un contrôle de connaissances', 'la seule inscription au CNB'], b: 1, e: 'Pratique dominante d’au moins quatre ans et examen / contrôle selon le dispositif.' },
      { q: 'Le certificat de spécialisation est délivré sous l’égide :', o: ['du tribunal judiciaire', 'du CNB', 'de la CARPA'], b: 1, e: 'Le président du CNB délivre les certificats de spécialisation.' }
    ],
    jury: [
      ...
      { q: 'La spécialisation crée‑t‑elle un monopole ?', r: 'Non. Elle est une information loyale du public sur une compétence reconnue, pas un monopole d’exercice. Tout avocat reste compétent dans les matières non réservées par la loi. En revanche, se prévaloir d’une spécialisation sans certificat est une publicité trompeuse. Deux mentions maximum, liste réglementée, pratique dominante et contrôle : le dispositif protège le justiciable autant que la profession.' },
      { q: 'Comment lier spécialisation et publicité ?', r: 'La mention autorisée peut figurer dans la publicité personnelle ; une mention usurpée viole le RIN art. 10. La spécialisation n’autorise pas non plus à garantir un résultat. Elle s’articule avec la formation continue pour le maintien de la compétence.' }
    ],
    cas: {
...

  {
    ...
    cartes: [
      ...
      { q: 'Qui tranche un différend entre avocats de barreaux différents ?', r: 'Un bâtonnier tiers ; le président du CNB peut désigner en cas de désaccord entre bâtonniers.', src: 'L. 1971 art. 21 ; D. 1991' },
      { q: 'Pourquoi le terme d’arbitrage est‑il trompeur ?', r: 'Parce qu’il s’agit d’une procédure ordinale organisée par la loi et le décret, avec voies de recours, plus que d’un arbitrage purement contractuel.', src: 'D. 27 nov. 1991, art. 142 s.' },
      { q: 'Quel est le premier réflexe en cas de différend entre confrères ?', r: 'Tenter la conciliation sous l’égide du bâtonnier avant toute judiciarisation inutile.', src: 'RIN ; L. 1971 art. 21' }
    ],
    qcm: [
      ...
      { q: 'Le bâtonnier, saisi d’un différend entre avocats, statue comme :', o: ['médiateur facultatif uniquement', 'autorité de conciliation puis, le cas échéant, dans un cadre juridictionnel organisé par les textes', 'juge pénal'], b: 1, e: 'Conciliation et procédure organisée (art. 21 L. 1971 ; D. 1991) : véritable voie ordinale.' },
      { q: 'Si les avocats appartiennent à des barreaux différents, on peut désigner :', o: ['le procureur général', 'un bâtonnier tiers', 'le président du TJ'], b: 1, e: 'Bâtonnier tiers ; le président du CNB peut désigner en cas de désaccord.' },
      { q: 'Le mot « arbitrage » pour ces différends :', o: ['désigne un arbitrage commercial classique', 'peut être trompeur : il s’agit d’une procédure ordinale / juridictionnelle organisée', 'exclut tout recours'], b: 1, e: 'Vocabulaire trompeur : procédure spécifique, pas un arbitrage purement contractuel.' },
      { q: 'Le recours contre la décision du bâtonnier en la matière :', o: ['est impossible', 'est organisé devant la cour d’appel selon les textes', 'va toujours au Conseil d’État'], b: 1, e: 'Voie de recours devant la cour d’appel, dans les conditions du décret.' }
    ],
    jury: [
      ...
      { q: 'Comment présenter le règlement des différends sans le confondre avec la discipline ?', r: 'Le différend oppose des intérêts d’avocats (collaboration, association, honoraires entre confrères, etc.). La discipline sanctionne un manquement aux devoirs professionnels. Le bâtonnier concilie et peut trancher dans le cadre légal ; la juridiction disciplinaire juge les infractions. Un même fait peut nourrir les deux voies, mais les finalités divergent : pacifier un conflit patrimonial ou relationnel vs protéger l’intérêt public de la profession.' },
      { q: 'Que faire si la conciliation échoue ?', r: 'Emprunter la procédure prévue par le décret : décision du bâtonnier, puis recours devant la cour d’appel si besoin. Respecter les délais. Éviter la publicité du conflit, au nom de la confraternité et de l’image de la profession.' }
    ],
    cas: {
...

  {
    ...
    cartes: [
      ...
      { q: 'Le préjudice est‑il requis pour poursuivre disciplinairement ?', r: 'Non. Il n’est pas une condition de l’action disciplinaire ; il influe sur le choix et le quantum de la sanction.', src: 'L. 1971 ; jurisprudence ordinale' },
      { q: 'Une négligence peut‑elle constituer une infraction disciplinaire ?', r: 'Oui, si elle présente une gravité suffisante ; l’intention frauduleuse n’est pas toujours requise.', src: 'RIN ; L. 1971' },
      { q: 'Discipline et action civile du client : indépendantes ?', r: 'Oui. L’action disciplinaire protège l’intérêt public de la profession ; l’action civile répare le préjudice du client.', src: 'L. 1971 ; C. civ.' }
    ],
    qcm: [
      ...
      { q: 'Le préjudice de la victime est‑il une condition de l’action disciplinaire ?', o: ['oui, toujours', 'non ; il influe sur le quantum de la sanction', 'seulement pour les peines les plus graves'], b: 1, e: 'Le préjudice n’est pas une condition de l’action ; il pèse sur la sanction.' },
      { q: 'L’infraction disciplinaire suppose :', o: ['toujours une intention frauduleuse', 'un manquement aux devoirs de la profession, même par négligence grave', 'uniquement une condamnation pénale préalable'], b: 1, e: 'Manquement aux devoirs professionnels ; la négligence grave peut suffire.' },
      { q: 'Les sanctions disciplinaires sont prévues notamment par :', o: ['le seul RIN', 'la loi de 1971 et le décret de 1991', 'le code de commerce'], b: 1, e: 'L. 1971 art. 22 s. et D. 1991 art. 183 : échelle des sanctions.' },
      { q: 'Un même fait peut entraîner :', o: ['discipline uniquement', 'discipline, pénal et civil, selon les qualifications', 'civil uniquement si le client est d’accord'], b: 1, e: 'Indépendance des poursuites : discipline ≠ action civile ≠ pénal.' }
    ],
    jury: [
      ...
      { q: 'Qu’est‑ce qu’une infraction disciplinaire ?', r: 'Un manquement aux devoirs essentiels de la profession : serment, RIN, code de déontologie, lois et règlements professionnels. Ce n’est pas le calque du droit pénal : pas besoin d’une incrimination pénale, ni d’un préjudice. La faute peut être une négligence grave. L’échelle des sanctions va de l’avertissement à la radiation, en passant par le blâme, l’interdiction temporaire, etc.' },
      { q: 'Comment le jury attend‑il que vous traitiez le concours de qualifications ?', r: 'En rappelant l’indépendance des voies : un fait peut être pénalement réprimé, civilement fautif et disciplinairement sanctionné. L’autorité de la chose jugée pénale s’impose sur le disciplinaire dans certaines limites, mais l’acquittement n’interdit pas toujours une faute déontologique distincte. Clarté et prudence dans les formules.' }
    ],
    cas: {
    ...
    cas2: {
      e: 'Un avocat omis de payer sa cotisation, ignore les relances, et adresse au bâtonnier un courriel public insultant. Quelles infractions envisagez‑vous ?',
      r: 'Plusieurs manquements possibles : manquement aux obligations ordinales (cotisation), manquement à la confraternité et à la délicatesse envers l’Ordre, atteinte à la dignité. Le préjudice n’est pas requis. La poursuite disciplinaire est distincte de l’omission du tableau pour défaut de cotisation. La liberté d’expression existe mais ne couvre pas l’insulte disproportionnée. Sanction proportionnée à la gravité et aux antécédents.'
    }
  },

  {
    ...
    qcm: [
      ...
      { q: 'Depuis 2004, le jugement disciplinaire relève :', o: ['du bâtonnier seul', 'd’une juridiction disciplinaire distincte (sauf particularité parisienne)', 'du CNB en premier ressort'], b: 1, e: 'Juridiction disciplinaire par ressort de cour d’appel ; à Paris, conseil de l’ordre en formation disciplinaire.' },
      { q: 'Le bâtonnier en matière disciplinaire est :', o: ['le juge', 'l’autorité de poursuite', 'le greffier'], b: 1, e: 'Autorité de poursuite ; séparation d’avec le jugement.' },
      { q: 'Les droits de la défense en discipline imposent notamment :', o: ['le huis clos absolu sans accès au dossier', 'l’accès au dossier, le contradictoire et l’assistance', 'la publicité obligatoire de tous les débats'], b: 1, e: 'Procès équitable : accès au dossier, contradictoire, assistance par un confrère.' },
      { q: 'L’appel des décisions disciplinaires se forme devant :', o: ['le Conseil d’État', 'la cour d’appel', 'le tribunal judiciaire'], b: 1, e: 'Appel devant la cour d’appel selon le dispositif du décret.' }
    ],
    jury: [
      ...
      { q: 'Pourquoi avoir séparé poursuite et jugement en 2004 ?', r: 'Pour satisfaire aux exigences du procès équitable (art. 6 CEDH) : ne plus confondre l’autorité qui poursuit et celle qui juge. Le bâtonnier poursuit ; la juridiction disciplinaire juge. À Paris, le conseil de l’ordre siège en discipline avec une séparation interne des fonctions. Les réformes de 2022 et 2025 ont encore précisé la procédure. C’est un axe majeur de l’oral.' },
      { q: 'Quels droits de la défense devez‑vous citer ?', r: 'Information des griefs, accès au dossier, délai pour préparer, assistance par un avocat, contradictoire, motivation de la décision, voies de recours. La suspension provisoire obéit à un régime particulier. Ne pas transformer l’oral en catalogue : relier chaque droit à la loyauté de la procédure.' }
    ],
    cas: {
    ...
    cas2: {
      e: 'Le bâtonnier vous informe d’une plainte et vous convoque. Vous découvrez que le rapporteur est un associé de l’avocat plaignant. Que faites‑vous ?',
      r: 'Vous soulevez immédiatement la cause de récusation / partialité objective : séparation des fonctions et apparence d’impartialité. Vous demandez le dessaisissement du rapporteur et la protection de vos droits de la défense. Vous répondez néanmoins aux griefs sur le fond pour ne pas faire obstacle à l’instruction. Vous documentez l’incident. Si la composition demeure irrégulière, vous réservez le moyen pour l’appel devant la cour d’appel.'
    }
  },

  {
    ...
    qcm: [
      ...
      { q: 'L’avocat omis reste‑t‑il justiciable de la discipline ?', o: ['non', 'oui, pour les faits antérieurs et selon les textes', 'seulement s’il le consent'], b: 1, e: 'Il reste membre de l’Ordre à certains égards et justiciable pour les faits concernés.' },
      { q: 'La suppléance vise à :', o: ['punir l’avocat', 'assurer la continuité de la défense et la protection des clients', 'remplacer le bâtonnier'], b: 1, e: 'Continuité de l’exercice et protection des justiciables.' },
      { q: 'L’administrateur provisoire peut être désigné en cas de :', o: ['simple retard de formation continue d’une heure', 'défaillance grave, interdiction, ou situations prévues par le décret', 'désaccord sur un honoraire de 100 euros'], b: 1, e: 'Situations de crise prévues par le décret : protection du cabinet et des clients.' },
      { q: 'L’omission peut être :', o: ['uniquement définitive', 'facultative ou de droit selon les causes (cotisation, incompatibilité, etc.)', 'prononcée par le seul client'], b: 1, e: 'Régime différencié : omission de droit ou facultative selon les hypothèses du décret.' }
    ],
    jury: [
      ...
      { q: 'Distinguez omission, suppléance et administration provisoire.', r: 'L’omission retire l’exercice (tableau) pour des causes légales ou facultatives, sans toujours éteindre la qualité ordinale ni la discipline. La suppléance organise le remplacement temporaire pour assurer les dossiers. L’administration provisoire confie à un tiers la gestion du cabinet en cas de défaillance grave. Les trois outils protègent le justiciable et la permanence de la défense, plus qu’ils ne « punissent » à eux seuls.' },
      { q: 'Que devient le secret en cas d’administration provisoire ?', r: 'L’administrateur est avocat : le secret continue de s’imposer. Il n’y a pas de libre accès pour des tiers non professionnels. L’Ordre supervise dans le respect des textes. C’est un point de vigilance à l’oral : urgence opérationnelle vs confidentialité.' }
    ],
    cas: {
...

  {
    ...
    cartes: [
      ...
      { q: 'Quel tribunal connaît de la liquidation judiciaire d’un avocat ?', r: 'Le tribunal judiciaire, et non le tribunal de commerce, l’avocat n’étant pas commerçant.', src: 'C. com. livre VI ; L. 1971' },
      { q: 'Que protéger en priorité en cas de liquidation ?', r: 'Les dossiers clients, le secret professionnel et la continuité de la défense, via l’Ordre (suppléance, administration).', src: 'D. 27 nov. 1991' },
      { q: 'L’avocat est‑il commerçant ?', r: 'Non. Cette qualification explique la compétence du tribunal judiciaire pour les procédures collectives.', src: 'C. com. ; L. 1971' }
    ],
    qcm: [
      ...
      { q: 'Le tribunal compétent pour la liquidation d’un avocat est :', o: ['le tribunal de commerce', 'le tribunal judiciaire', 'le conseil de discipline'], b: 1, e: 'TJ, jamais le tribunal de commerce : l’avocat n’est pas commerçant.' },
      { q: 'Le statut d’entrepreneur individuel (loi du 14 février 2022) :', o: ['supprime toute procédure collective', 'peut concerner l’avocat individuel et séparer patrimoines selon le dispositif', 'interdit l’exercice individuel'], b: 1, e: 'Loi EI 2022 : articulation avec l’exercice individuel à maîtriser sans inventer de seuils.' },
      { q: 'En liquidation, le sort des dossiers clients impose :', o: ['l’abandon immédiat', 'des mesures de protection, suppléance / administration, information de l’Ordre', 'le transfert automatique au liquidateur non avocat'], b: 1, e: 'Protection des clients et du secret ; l’Ordre intervient pour la continuité.' },
      { q: 'La liquidation judiciaire emporte des conséquences ordinales :', o: ['aucune', 'possibles omission et mesures de protection du cabinet', 'la radiation automatique sans procédure'], b: 1, e: 'Conséquences sur l’inscription et organisation de la suite : textes du décret de 1991.' }
    ],
    jury: [
      ...
      { q: 'Pourquoi la compétence du TJ est‑elle un réflexe d’oral ?', r: 'Parce que l’avocat n’est pas commerçant : les procédures collectives relèvent du tribunal judiciaire. Confondre avec le tribunal de commerce est une faute classique. Ensuite, articuler liquidation, omission, sort des honoraires et protection des dossiers. La loi EI de 2022 peut entrer dans la discussion pour l’exercice individuel, sans inventer de chiffres.' },
      { q: 'Comment concilier droits des créanciers et secret professionnel ?', r: 'Le liquidateur n’a pas un accès libre au secret : les pièces couvertes restent protégées ; l’Ordre et les mécanismes de suppléance / administration organisent la continuité. Les créances d’honoraires et de tiers suivent le droit des entreprises en difficulté, sans livrer les confidences des clients.' }
    ],
    cas: {
