...
export const STRUCTURES = [
  {
    ...
    cartes: [
      ...
      { q: 'Une SCM exerce‑t‑elle la profession d’avocat ?', r: 'Non. La structure de moyens ne reçoit pas de clients, ne conclut pas de conventions d’honoraires et n’exerce pas la profession.', src: 'L. 1971 art. 7 ; D. 1991' },
      { q: 'Quel apport de la loi du 14 février 2022 pour l’avocat individuel ?', r: 'Le statut d’entrepreneur individuel et la séparation des patrimoines professionnel / personnel selon le dispositif légal.', src: 'L. 14 févr. 2022' },
      { q: 'L’avocat individuel est‑il dispensé d’assurance RCP ?', r: 'Non. Les assurances obligatoires et les devoirs déontologiques s’imposent quel que soit le mode d’exercice.', src: 'L. 1971 art. 27' }
    ],
    qcm: [
      ...
      { q: 'La structure de moyens :', o: ['exerce la profession à la place de l’avocat', 'n’exerce pas la profession : elle ne reçoit pas de clients ni ne plaide', 'remplace la CARPA'], b: 1, e: 'SCM / structures de moyens : pas d’exercice de la profession ni de clientèle propre.' },
      { q: 'L’avocat individuel peut adopter le statut d’entrepreneur individuel :', o: ['non, jamais', 'oui, depuis la loi du 14 février 2022, selon ce dispositif', 'uniquement s’il est collaborateur'], b: 1, e: 'Loi EI 2022 applicable à l’exercice individuel, avec séparation des patrimoines selon les règles légales.' },
      { q: 'L’exercice individuel implique :', o: ['aucune assurance', 'les mêmes obligations d’assurance, de comptabilité et de déontologie que les autres modes', 'une discipline distincte'], b: 1, e: 'Mêmes devoirs professionnels ; seul le mode d’exercice change.' },
      { q: 'L’avocat individuel peut‑il accueillir un collaborateur ?', o: ['non', 'oui, tout en demeurant responsable de la structure d’accueil selon les textes', 'uniquement un stagiaire non avocat'], b: 1, e: 'L’exercice individuel n’interdit pas la collaboration libérale ou salariée.' },
      { q: 'Le choix de l’exercice individuel :', o: ['est imposé la première année', 'reste libre, sous réserve des conditions d’inscription', 'doit être autorisé par le CNB'], b: 1, e: 'Liberté du mode d’exercice, contrôlée à l’inscription sur les conditions déontologiques.' }
    ],
    jury: [
      ...
      { q: 'Comment présenter l’avocat individuel sans le caricaturer en « petit » exercice ?', r: 'C’est un mode d’exercice à part entière, historiquement premier, qui porte la plénitude des droits et devoirs. Il se distingue des structures d’exercice (SEP, SEL, etc.) et des structures de moyens. La loi EI de 2022 modernise la protection patrimoniale. L’indépendance y est souvent plus visible, mais la solitude n’excuse ni le défaut de formation, ni le défaut d’assurance, ni le défaut de conflict check.' },
      { q: 'Structure de moyens et structure d’exercice : une phrase discriminante ?', r: 'La structure d’exercice porte la clientèle et l’activité réglementée ; la structure de moyens met en commun des moyens sans exercer. Confondre les deux est une erreur classique : une SCM ne plaide pas, une SEL oui.' }
    ],
    cas: {
...

  {
    ...
    qcm: [
      ...
      { q: 'Les clauses de non‑concurrence et de respect de clientèle dans le contrat de collaboration sont :', o: ['librement valables', 'nulles selon la jurisprudence et les textes professionnels', 'obligatoires'], b: 1, e: 'Nullité des clauses de non‑concurrence / respect de clientèle en collaboration.' },
      { q: 'Le collaborateur libéral :', o: ['n’a pas de clientèle personnelle', 'doit pouvoir développer une clientèle personnelle', 'est salarié de l’Ordre'], b: 1, e: 'Droit et devoir de développer une clientèle personnelle, marque du libéral.' },
      { q: 'Le collaborateur salarié relève notamment :', o: ['du seul RIN, jamais du droit du travail', 'du droit du travail et de la convention collective, outre la déontologie', 'du statut de fonctionnaire'], b: 1, e: 'Salariat + convention collective nationale des cabinets + déontologie.' },
      { q: 'En cas de litige sur le contrat de collaboration, le bâtonnier :', o: ['est incompétent', 'intervient comme autorité de conciliation / arbitrage selon les textes', 'renvoie toujours au conseil de prud’hommes sans filtre'], b: 1, e: 'Compétence ordinale organisée pour les litiges de collaboration.' }
    ],
    jury: [
      ...
      { q: 'Collaborateur libéral vs salarié : quels points d’attention ?', r: 'Le libéral conserve l’indépendance technique et le droit à une clientèle personnelle ; le salarié est subordonné mais reste avocat tenu au serment. Les deux sont soumis au RIN. Les clauses de non‑concurrence sont nulles en collaboration libérale. La rétrocession doit être digne et conforme aux usages. Le jury attend que vous ne « salarisiez » pas indûment le libéral ni n’oubliiez le droit du travail pour le salarié.' },
      { q: 'Que répondre sur la clientèle personnelle du collaborateur ?', r: 'Elle est un droit : l’empêcher est contraire au statut. Les moyens du cabinet doivent permettre son exercice effectif (temps, locaux, signature). À la fin de la collaboration, la liberté de panneau et de suivi de clientèle s’exerce dans le respect du secret et de la confraternité, sans clause de captation illicite.' }
    ],
    cas: {
    ...
    cas2: {
      e: 'Votre contrat de collaboration libérale prévoit une clause de « respect de clientèle » de deux ans sur tout le ressort de la cour. Valide ?',
      r: 'Non : de telles clauses sont nulles. Vous pouvez saisir le bâtonnier pour faire constater la nullité et organiser la fin de collaboration. Vous continuez à respecter le secret et la confraternité, mais vous n’êtes pas lié par cette clause. Une rétrocession indigne ou un empêchement de clientèle personnelle seraient des griefs complémentaires.'
    }
  },

  {
    ...
    qcm: [
      ...
      { q: 'La notion d’associé est :', o: ['définie de façon unique par la loi de 1971', 'peu définie par la loi : l’associé n’est pas nécessairement majoritaire ni gérant', 'synonyme de collaborateur'], b: 1, e: 'Pas de définition légale unique ; l’associé détient des droits sociaux, sans être forcément dirigeant.' },
      { q: 'L’avocat associé demeure tenu :', o: ['uniquement des dettes sociales', 'personnellement au respect de la déontologie, indépendamment de la structure', 'exclusivement au pacte d’associés'], b: 1, e: 'La structure n’efface pas les devoirs personnels de l’avocat.' },
      { q: 'Le retrait d’un associé :', o: ['est toujours libre sans délai', 'obéit aux statuts, au pacte et aux règles ordinales de protection des clients', 'est décidé par le seul bâtonnier'], b: 1, e: 'Statuts + pacte + continuité des dossiers et information de l’Ordre si besoin.' },
      { q: 'L’ordonnance du 8 février 2023 a notamment :', o: ['supprimé les SEL', 'réformé le régime des sociétés d’exercice libéral', 'interdit l’association entre avocats'], b: 1, e: 'Ord. 2023‑77 : modernisation des SEL et structures d’exercice.' }
    ],
    jury: [
      ...
      { q: 'L’associé est‑il « plus » avocat que le collaborateur ?', r: 'Non en dignité : le serment est le même. Mais il participe aux droits sociaux, aux décisions collectives et souvent à la responsabilité patrimoniale selon la forme sociale. Il doit veiller aux conflits, à la LCB‑FT de la structure et à la publicité. Le pacte d’associés ne peut contrarier la déontologie. Distinguer associé, gérant et collaborateur évite les confusions d’oral.' },
      { q: 'Que faire en cas de conflit entre associés sur un dossier sensible ?', r: 'Conflict check collectif, déport si besoin, information du bâtonnier en cas de blocage. Le secret du client prime sur la stratégie interne. La structure doit avoir des procédures écrites. Le retrait ou la cession de parts suivent les statuts sans abandonner les clients.' }
    ],
    cas: {
...

  {
    ...
    qcm: [
      ...
      { q: 'L’immatriculation de la société d’exercice :', o: ['suit toujours l’inscription des associés', 'précède en principe la demande d’inscription au tableau de la structure', 'est inutile pour les SEL'], b: 1, e: 'Demande d’immatriculation avant l’inscription ordinale de la structure, selon le schéma classique.' },
      { q: 'Les structures d’exercice permettent :', o: ['d’échapper au secret professionnel', 'd’exercer en commun dans un cadre sociétaire encadré', 'de partager les honoraires avec n’importe quel tiers'], b: 1, e: 'Exercice en commun réglementé ; secret et déontologie demeurent.' },
      { q: 'L’ordonnance n° 2023‑77 du 8 février 2023 :', o: ['ne concerne pas les avocats', 'modernise le droit des SEL et de l’interprofessionnalité capitalistique', 'supprime le RIN'], b: 1, e: 'Réforme majeure des sociétés d’exercice libéral.' },
      { q: 'Une structure d’exercice doit être inscrite :', o: ['seulement au RCS', 'auprès de l’Ordre, outre les formalités de publicité légale', 'seulement auprès du CNB'], b: 1, e: 'Inscription ordinale de la structure, condition d’exercice.' }
    ],
    jury: [
      ...
      { q: 'Comment classer les structures sans noyer le jury ?', r: 'Distinguer : exercice individuel ; collaboration ; association ; sociétés d’exercice (SEP, SCP, SEL variants, etc.) ; structures de moyens ; interprofessionnalité. Pour chaque famille : qui exerce, qui contracte avec le client, qui est responsable, quelles formalités ordinales. Citer l’ordonnance de 2023 pour montrer l’actualité, sans réciter tout le code de commerce.' },
      { q: 'Pourquoi l’immatriculation avant l’inscription ?', r: 'Parce que la société doit exister juridiquement pour être inscrite au tableau et exercer. L’Ordre vérifie ensuite la conformité déontologique (objet, associés, assurances). Inverser l’ordre crée des situations irrégulières d’exercice.' }
    ],
    cas: {
    ...
    cas2: {
      e: 'Des associés veulent créer une SEL avec un objet social « conseil en stratégie et avocat ». Le projet de statuts prévoit le partage d’honoraires avec un cabinet de lobbying non avocat. Que rétorquez‑vous ?',
      r: 'L’objet doit rester compatible avec l’exercice de la profession ; le partage d’honoraires avec un non‑avocat est prohibé. Le lobbying hors cadre peut heurter indépendance et dignité. Il faut reprendre les statuts, écarter le partage, vérifier assurances et inscription ordinale, et au besoin interroger le bâtonnier avant toute immatriculation. L’ordonnance de 2023 n’a pas aboli ces interdits déontologiques.'
    }
  },

  {
    ...
    qcm: [
      ...
      { q: 'Le partage d’honoraires avec un non‑avocat est :', o: ['libre depuis 2015', 'prohibé', 'obligatoire en SPFPL'], b: 1, e: 'Prohibition maintenue : pas de partage ni de rémunération d’apport d’affaires avec un non‑avocat.' },
      { q: 'L’interprofessionnalité d’exercice et capitalistique :', o: ['sont synonymes', 'doivent être distinguées ; la seconde a été ouverte sous conditions par la loi de 2015 et précisée en 2023', 'sont toutes deux interdites'], b: 1, e: 'Distinction exercice / capital ; ouverture encadrée (2015, ord. 2023).' },
      { q: 'Une SPFPL a pour objet :', o: ['d’exercer elle‑même la profession d’avocat', 'de détenir des participations dans des sociétés d’exercice', 'de remplacer la CARPA'], b: 1, e: 'Holding de participations, pas d’exercice direct de la profession.' },
      { q: 'Le secret professionnel en structure interprofessionnelle :', o: ['disparaît', 'doit être aménagé sans être trahi ; pas de circulation libre des confidences', 'est opposable seulement aux clients'], b: 1, e: 'Le secret demeure : cloisonnements et informations limitées au nécessaire.' }
    ],
    jury: [
      ...
      { q: 'Que répondre à « l’interprofessionnalité a tout libéré » ?', r: 'Non. La loi de 2015 et l’ordonnance de 2023 ont ouvert des structures capitalistiques et certaines formes d’exercice multiprofessionnel, mais le partage d’honoraires avec un non‑avocat, le secret, l’indépendance et les incompatibilités demeurent. Il faut distinguer collaboration ponctuelle, exercice commun et détention capitalistique (SPFPL). Le RIN art. 18 reste un guide.' },
      { q: 'Quel risque principal pour le justiciable ?', r: 'La dilution du secret et des conflits d’intérêts dans un groupe multiprofessionnel. D’où ethical walls, information claire sur qui est avocat, et refus de faire circuler les confidences vers des métiers non couverts par le même secret.' }
    ],
    cas: {
